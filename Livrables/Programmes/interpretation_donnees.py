...
moyennes_velos = extraction_moyennes_velos("../Données/velos.txt")
moyennes_voitures = extraction_moyennes_voitures("../Données/voitures.txt")
...
with open("../Données/donnees_courbe.dat", "w", encoding="utf-8") as fichier:
    for i in range(nombre_prelevements):
